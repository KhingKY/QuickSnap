...
namespace CardGames
{
    public class SnapGame
    {
        public static void LoadResources()
        {
			...
			SwinGame.LoadFontNamed("GameFont","ChuckFive-Regular.otf",24);
        }
		...
		private static void HandleUserInput(Snap myGame)
		{
			...
			if (myGame.IsStarted)
			{
				if (SwinGame.KeyTyped (KeyCode.vkLSHIFT) && Swingame.KeyTyped (KeyCode.vk_RSHIFT))
				{
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				...
				SwinGame.DrawText ("Player 2 score: " + myGame.Score(0), Color.White,"GameFont", 0, 30);
